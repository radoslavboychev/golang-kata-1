...
const (
	...
	ErrFailedToResolveAuthorsInvalid   = Error("failed to resolve authors, authors are invalid")
	ErrFailedToResolveBooksInvalid     = Error("failed to resolve authors, books are invalid")
	ErrFailedToResolveMagazinesInvalid = Error("failed to resolve authors, magazines are invalid")
	ErrorISBNIsNull                    = Error("ISBN is invalid")
)
